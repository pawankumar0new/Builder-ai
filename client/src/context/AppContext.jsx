...
export function AppContextProvider({children}){
    ...
    return(
        <AppContext.Provider value={{user, loadingUser, login, register, projects, loadingProjects, activeProject, loadingActiveProject, chatLoading, generatingProject, activeFile, showCode, setActiveFile, setShowCode, loadProject, loadProjects, handleGenerate, handleDelete, logout, updateProjectFiles}}> 
            {children}
        </AppContext.Provider>
    )
}
